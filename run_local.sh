...
export MONGODB_URI="mongodb+srv://votre_username:votre_password@cluster.mongodb.net/?retryWrites=true&w=majority&appName=VotreApp&tlsAllowInvalidCertificates=true&connectTimeoutMS=30000&serverSelectionTimeoutMS=30000"
...
streamlit run st_trial_analytics.pyScript pour configurer les variables d'environnement pour le développement local
# Utilisez ce script au lieu de créer un fichier .env si vous préférez
